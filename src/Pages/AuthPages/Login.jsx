        ...
        <div className="hero-content flex-col lg:flex-row gap-16">
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <div className="card-body p-16">
                <h3 className="text-3xl font-semibold mb-10 text-center">Please Log in</h3>
                {error && (
                ...
                <div className="form-control mt-6">
                  ...
                  />
                   <p className="mt-6">
                    ...
                    <Link to="/register" className="label-text-alt link link-hover text-base ml-2 text-my-primary">Sing Up</Link>
                  </p>
                </div>
              </form>
            </div>
